(function () {
  ...
  function requestImage(searchedForText) {
    ...
    xhr.onload = addImage;
    xhr.setRequestHeader('Authorization', 'Client-ID d7cb1f9fd28e1832f1718639df593eb0faf813897331b96d0b0243670708f072');
    xhr.send();
  }

  function requestArticles(searchedForText) {
    // NewYork Times API KEy
    // 965915652ca14294baf33b5f5631c146
    const artXhr = new XMLHttpRequest();
    artXhr.open('GET', `http://api.nytimes.com/svc/search/v2/articlesearch.json?q=${searchedForText}&api-key=965915652ca14294baf33b5f5631c146`);
    artXhr.onload = addArticles;
    artXhr.send();
  }
